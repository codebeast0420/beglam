      ...
      <ScrollView>
        <View className="px-9 pt-14 pb-12">
          <View className="bg-white p-6 pt-3 rounded-3xl mb-9">
            <Text className="text-primary-300 text-base font-gilroy mb-4">Day</Text>
            <Text className="text-primary-300 text-base font-gilroy-bold">10.02.19</Text>
          </View>
          ...
          <View className="bg-white px-6 py-3 rounded-3xl">
            <View className="flex-row justify-between">
              ...
              <Text className="text-secondary-300 text-lg font-gilroy-bold">$915</Text>
            </View>
          </View>
        </View>
      </ScrollView>
...
export default ProFinancesDetail;
